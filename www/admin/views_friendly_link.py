...
def friendly_link(request, template_name='admin/friendly_link.html'):
    from www.admin.models import FriendlyLink
...
def add_friendly_link(request):
    ...
    return FriendlyLinkBase().add_friendly_link(name, href, link_type=link_type, sort_num=sort_num, des=des)
...
def modify_friendly_link(request):
    ...
    return FriendlyLinkBase().modify_friendly_link(
        link_id, link_type=link_type, name=name, href=href, sort_num=sort_num, des=des
    )
