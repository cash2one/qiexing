...
SERVER_NAME = 'QIEXING_WEB0' if not LOCAL_FLAG else 'DEVELOPER'
SERVER_DOMAIN = 'qiexing.com' if not LOCAL_FLAG else 'a.com:8000'
MAIN_DOMAIN = 'http://www.%s' % SERVER_DOMAIN
IMG0_DOMAIN = 'http://img0.qiexing.com'    # 'http://zimg0.qiniudn.com'

EMAIL_FROM = u'"智选" <service@qiexing.com>'
EMAIL_HOST_USER = 'service@qiexing.com'
EMAIL_HOST_PASSWORD = 'qiexing2013'
...
SECRET_KEY = 'uf-9^7=s3eot_id*ltpnklid3tfr*w@z5x#1y0^hn6enfr+@j5'
...
SESSION_COOKIE_DOMAIN = '.qiexing.com' if not LOCAL_FLAG else '.a.com'
